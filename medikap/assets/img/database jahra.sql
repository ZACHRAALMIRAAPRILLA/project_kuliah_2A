...
CREATE TABLE IF NOT EXISTS `tb_kategori_pasien` (
  ...
  `kategori_pasien` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
  PRIMARY KEY (`id_kat_pasien`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;

-- Dumping data for table db_medikaapp.tb_kategori_pasien: ~2 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tb_list_pemeriksaan` (
  ...
  `catatan` varchar(300) CHARACTER SET utf8mb4 DEFAULT NULL,
  `harga` varchar(300) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_pemeriksaan` (
  ...
  `pasien` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2312241137129 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `tb_riwayat_pasien` (
  ...
  `nama_pasien` varchar(200) CHARACTER SET utf8mb4 DEFAULT NULL,
